 ...
 */
public class TrainAsKnowledgeBaseTemplate extends AbstractOBIETemplate<Scope> {
	...
	private static Logger log = LogManager.getFormatterLogger(TrainAsKnowledgeBaseTemplate.class.getName());
	...
	class Scope extends FactorScope {
		...
		public Scope(Class<? extends IOBIEThing> entityRootClassType, AbstractIndividual value1, String slotName,
			...
			super(TrainAsKnowledgeBaseTemplate.this, entityRootClassType, value1, value2, slotName,
					interSlotComparison);
			this.value1 = value1;
			this.value2 = value2;
